...
const CONFIG = {
    title: "注入漏洞扫描",
    description: "专项扫描 SQL 注入、OS 命令注入、模板注入 (SSTI)、日志注入 (CRLF) 四类注入漏洞。" +
...
export function registerScanInjection(server) {
    server.registerTool("scan_injection", CONFIG, async (args) => {
...
//# sourceMappingURL=scan-injection.js.map